...
if [[ $LIBSLIRP_VERS != 4.7.0* ]]; then
	...
	wget -nv  http://ftp.de.debian.org/debian/pool/main/libs/libslirp/libslirp0_4.7.0-1_amd64.deb -O libslirp0.deb
...
if [[ $LIBSLIRP_DEV_VERS != 4.7.0* ]]; then
    ...
    wget -nv  http://ftp.de.debian.org/debian/pool/main/libs/libslirp/libslirp-dev_4.7.0-1_amd64.deb -O libslirp-dev.deb
